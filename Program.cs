...
namespace C_sharp_OOP
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Corolla corolla = new();
            System.Console.WriteLine(corolla.HowManyWheels());
            System.Console.WriteLine(corolla.GetColorName());
            System.Console.WriteLine(corolla.GetBrandName());

            Civic civic = new();
            System.Console.WriteLine(civic.HowManyWheels());
            System.Console.WriteLine(civic.GetColorName());
            System.Console.WriteLine(civic.GetBrandName());
            #endregion
        }
    }
}
